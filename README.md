...
Vehicle weight (1.245e-03), spoiler angle (6.877e-02), and AWD (-3.411e+00) provide a non-random amount of variance to the mpg values in the dataset.

**Is the slope of the linear model considered to be zero? Why or why not?**

The slope of the linear model is not considered zero since the p-value is 5.35e-11. Comparing this to the significance level, we can reject a null hypothesis.

**Does this linear model predict mpg of MechaCar prototypes effectively? Why or why not?**

Yes, this linear model predicts mpg of MechaCar prototypes effectively. The multiple R-squared value is equal to 0.7149 or 71.49% which means that ~71% of the time the predictions will be accurate using this linear model.
